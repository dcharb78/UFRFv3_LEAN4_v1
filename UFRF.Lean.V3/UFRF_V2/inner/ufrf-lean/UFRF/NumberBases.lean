...
theorem measured_count : measuredPositions.card = 12 := by
  simp [measuredPositions, observer]
  decide
...
theorem perceived_count : perceivedPositions.card = 10 := by
  simp [perceivedPositions]
  decide
