...
|--------|---------|------------|
| Constants | φ, π, τ, numeric identities | `subscale_flip_is_one_half` |
...
| Calculus | Differentiation as scale descent | `ftc_scale_roundtrip` |
| Riemann | Critical line Re(s) = 1/2 | `ufrf_riemann` |
| Monster | Emergence, Moonshine | `monster_factorization` |
-/
